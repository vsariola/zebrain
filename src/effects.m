...
while pattern < 35
    ...
    h_image.CData = uint8(tanh((ww/80*interp([0,50,224,242,258,259,1024,1095,1106,1122],[0,.4,.8,0,0,1,1,.6,0,0],beat) + sync(1))/64)*256); 
