...
texts = {'\___\zzz\/zz_\_,-.__\.-.-.zz.~z\/\_·zz/\zzzz\z\`\/z\\z\z\z.','__z__z\__,-.__.,-.z~z/_\/__\/z\z\_\\\z\','4096 bytesz|zMATLABz|zDemosplash 2019','.s$s,s$s,~¶§§§§§§§²~`§§§§P´~`§´','Bits''n''Bites~p01~Brothomstates~Kooma~Orange~CNCD~NoooN','code:pestis/bC!','music:distance/TPOLM','ascii:tes-la/bC!'};
